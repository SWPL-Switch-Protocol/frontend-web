      ...
      <main className="flex-1 px-6 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16" style={{ paddingTop: "60px" }}>
            <div
              className={`rounded-3xl p-10 mx-auto transition-all ${
                showConfetti ? "animate-pulse-once" : ""
              }`}
            ...
            >
              ...
              <p className="text-lg" style={{ color: "#B3ADA7" }}>
                Your successful transaction increased your trust level and
                granted access to your neighborhood community.
              </p>
            </div>
          </div>
                ...
                >
                  ...
                  >
                    <i
                      ...
                      style={{ color: "#FF8C42", fontSize: "24px" }}
                    ></i>
                  </div>
                  <h3
