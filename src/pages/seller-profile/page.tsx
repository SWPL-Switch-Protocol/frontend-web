...
const SellerProfilePage = () => {
  ...
  const sellerData = {
    ...
    disputesResolved: 0,
    badges: [
      { name: 'Safe Trader SBT', issued: 'Jan 2025', status: 'Non-transferable ✅' },
      { name: 'Community Helper SBT', issued: 'Feb 2025', status: 'Non-transferable ✅' },
      { name: 'Top Neighborhood Contributor', issued: 'Mar 2025', status: 'Non-transferable ✅' },
    ],
    listings: [
      {
        id: '13',
        image: 'https://readdy.ai/api/search-image?query=Nintendo%20Switch%20Lite%20yellow%20handheld%20gaming%20console%20on%20clean%20minimal%20surface%20soft%20natural%20lighting%20professional%20product%20photography%20high%20quality%20sharp%20focus%20modern%20aesthetic&width=400&height=400&seq=seller-listing1&orientation=squarish',
      ...
      {
        id: '15',
        image: 'https://readdy.ai/api/search-image?query=Pokemon%20trading%20card%20collection%20holographic%20rare%20cards%20on%20minimal%20surface%20soft%20lighting%20clean%20product%20photography%20high%20quality%20sharp%20focus%20collectible%20gaming%20cards%20modern%20aesthetic&width=400&height=400&seq=seller-listing3&orientation=squarish',
    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#1B1B1B' }}>
      ...
      <main className="flex-1 px-6 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="rounded-3xl p-8 mb-8" style={{ backgroundColor: '#1F1F1F' }}>
            <div className="flex items-start gap-6 mb-6">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-bold mb-2" style={{ color: '#F5F3F0' }}>
                  {sellerData.username}
                </h2>
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  >
                    <span className="font-semibold text-sm">✅ {sellerData.trustLevel}</span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="rounded-2xl p-6 text-center" style={{ backgroundColor: '#262626' }}>
            ...
            <div className="space-y-4">
              {sellerData.badges.map((badge, index) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <h4 className="text-lg font-semibold mb-1" style={{ color: '#F5F3F0' }}>
                      {badge.name}
                    </h4>
          ...
          <div className="mb-8">
            <h3 className="text-2xl font-bold mb-6" style={{ color: '#F5F3F0' }}>
              Items for sale
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {sellerData.listings.map((listing) => (
                ...
                >
                  ...
                  <p className="text-2xl font-bold mb-2" style={{ color: '#FF8C42' }}>
                    ${listing.price}
                  </p>
                  <p className="text-sm" style={{ color: '#B3ADA7' }}>
                    📍 {listing.distance}
              ...
              {sellerData.recentActivity.map((activity, index) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    >
                      <i className={activity.icon} style={{ color: activity.color, fontSize: '20px' }}></i>
                    </div>
                    <div>
          ...
          <div className="rounded-2xl p-6 mb-8" style={{ backgroundColor: '#1F1F1F' }}>
            ...
            <div className="space-y-3 mb-4">
              <div className="flex items-center gap-2">
                <span className="text-sm" style={{ color: '#B3ADA7' }}>Neighborhood DAO:</span>
                <span className="text-sm font-medium" style={{ color: '#F5F3F0' }}>
                  {sellerData.dao.neighborhood}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-sm" style={{ color: '#B3ADA7' }}>Role:</span>
                <span className="text-sm font-medium" style={{ color: '#F5F3F0' }}>
                  {sellerData.dao.role}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-sm" style={{ color: '#B3ADA7' }}>Contributions:</span>
                <span className="text-sm font-medium" style={{ color: '#F5F3F0' }}>
              ...
              {!showAIDemo ? (
                <>
                  <div className="flex items-center gap-2 mb-1">
                    <i className="ri-check-circle-line text-lg" style={{ color: '#4CAF50' }}></i>
                    <span className="font-medium text-sm" style={{ color: '#F5F3F0' }}>
                ...
                <>
                  <div className="flex items-center gap-2 mb-1">
                    <i className="ri-alert-line text-lg" style={{ color: '#FFB84D' }}></i>
                    <span className="font-medium text-sm" style={{ color: '#F5F3F0' }}>
