  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <i className="ri-check-circle-line text-xl" style={{ color: '#4CAF50' }}></i>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="rounded-3xl p-8 mb-8" style={{ backgroundColor: '#1F1F1F' }}>
            <div className="flex items-start justify-between mb-6">
              ...
              <div
                className={`px-4 py-2 rounded-full transition-all ${badgePulse ? 'animate-pulse' : ''}`}
                style={{ backgroundColor: '#E8F0E6', color: '#6E8B5E' }}
              >
                <span className="font-semibold text-sm">✅ Trusted Neighbor</span>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs" style={{ color: '#8F8A84' }}>
                    Badges are permanently bound to your wallet and cannot be moved.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center gap-4">
                  <div
                    ...
                    style={{ backgroundColor: '#2E4B36' }}
                  >
                    <i className="ri-check-line text-xl" style={{ color: '#4CAF50' }}></i>
                  </div>
                  <div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  >
                    <i className="ri-edit-line text-xl" style={{ color: '#FF8C42' }}></i>
                  </div>
                  <div>
                    <p className="font-medium mb-1" style={{ color: '#F5F3F0' }}>
                      Review pending
              ...
              >
                <div className="flex items-center gap-4">
                  <div
                    ...
                    style={{ backgroundColor: '#3A3A3A' }}
                  >
                    <i className="ri-trophy-line text-xl" style={{ color: '#FFD700' }}></i>
                  </div>
                  <div>
                    <p className="font-medium mb-1" style={{ color: '#F5F3F0' }}>
