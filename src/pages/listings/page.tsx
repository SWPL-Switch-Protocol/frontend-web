...
export default function Listings() {
  ...
  const sortOptions = ['Newest', 'Lowest price', 'Highest price', 'Highest trust'];
  ...
  const mockListings: Listing[] = [
    {
      id: '1',
      image: 'https://readdy.ai/api/search-image?query=Nintendo%20Switch%20OLED%20white%20gaming%20console%20on%20clean%20minimal%20white%20surface%20with%20soft%20natural%20lighting%20professional%20product%20photography%20high%20quality%20sharp%20focus%20modern%20aesthetic&width=400&height=400&seq=listing1&orientation=squarish',
    ...
    {
      id: '2',
      image: 'https://readdy.ai/api/search-image?query=Apple%20AirPods%20Pro%20white%20wireless%20earbuds%20in%20charging%20case%20on%20minimal%20beige%20surface%20soft%20lighting%20clean%20product%20photography%20premium%20quality%20sharp%20details%20modern%20style&width=400&height=400&seq=listing2&orientation=squarish',
    ...
    {
      id: '3',
      image: 'https://readdy.ai/api/search-image?query=Sony%20PlayStation%205%20console%20white%20modern%20gaming%20system%20on%20clean%20surface%20with%20controller%20soft%20studio%20lighting%20professional%20product%20photography%20high%20quality%20sharp%20focus%20contemporary%20aesthetic&width=400&height=400&seq=listing3&orientation=squarish',
    ...
    {
      id: '4',
      image: 'https://readdy.ai/api/search-image?query=Canon%20DSLR%20camera%20professional%20black%20body%20with%20lens%20on%20minimal%20surface%20soft%20natural%20lighting%20clean%20product%20photography%20high%20quality%20sharp%20details%20modern%20photography%20equipment%20aesthetic&width=400&height=400&seq=listing4&orientation=squarish',
    ...
    {
      id: '5',
      image: 'https://readdy.ai/api/search-image?query=Apple%20iPad%20Pro%20silver%20tablet%20device%20on%20clean%20white%20surface%20with%20Apple%20Pencil%20soft%20studio%20lighting%20professional%20product%20photography%20premium%20quality%20sharp%20focus%20modern%20minimalist%20aesthetic&width=400&height=400&seq=listing5&orientation=squarish',
    ...
    {
      id: '6',
      image: 'https://readdy.ai/api/search-image?query=Trek%20mountain%20bike%20black%20and%20orange%20outdoor%20bicycle%20on%20clean%20background%20soft%20natural%20lighting%20professional%20product%20photography%20high%20quality%20sharp%20details%20modern%20sports%20equipment%20aesthetic&width=400&height=400&seq=listing6&orientation=squarish',
    ...
    {
      id: '7',
      image: 'https://readdy.ai/api/search-image?query=Pokemon%20trading%20card%20collection%20holographic%20rare%20cards%20on%20minimal%20surface%20soft%20lighting%20clean%20product%20photography%20high%20quality%20sharp%20focus%20collectible%20gaming%20cards%20modern%20aesthetic&width=400&height=400&seq=listing7&orientation=squarish',
    ...
    {
      id: '8',
      image: 'https://readdy.ai/api/search-image?query=modern%20beige%20fabric%20sofa%20couch%20furniture%20piece%20on%20clean%20white%20background%20soft%20studio%20lighting%20professional%20product%20photography%20high%20quality%20sharp%20details%20contemporary%20home%20furniture%20aesthetic&width=400&height=400&seq=listing8&orientation=squarish',
    ...
    {
      id: '9',
      image: 'https://readdy.ai/api/search-image?query=Apple%20MacBook%20Air%20silver%20laptop%20computer%20on%20minimal%20white%20surface%20soft%20natural%20lighting%20professional%20product%20photography%20premium%20quality%20sharp%20focus%20modern%20technology%20aesthetic&width=400&height=400&seq=listing9&orientation=squarish',
    ...
    {
      id: '10',
      image: 'https://readdy.ai/api/search-image?query=outdoor%20camping%20tent%20orange%20and%20gray%20portable%20shelter%20on%20clean%20background%20soft%20natural%20lighting%20professional%20product%20photography%20high%20quality%20sharp%20details%20modern%20outdoor%20gear%20aesthetic&width=400&height=400&seq=listing10&orientation=squarish',
    ...
    {
      id: '11',
      image: 'https://readdy.ai/api/search-image?query=Bose%20wireless%20headphones%20black%20premium%20audio%20equipment%20on%20minimal%20surface%20soft%20studio%20lighting%20professional%20product%20photography%20high%20quality%20sharp%20focus%20modern%20technology%20aesthetic&width=400&height=400&seq=listing11&orientation=squarish',
    ...
    {
      id: '12',
      image: 'https://readdy.ai/api/search-image?query=wooden%20dining%20table%20set%20with%20four%20chairs%20natural%20wood%20furniture%20on%20clean%20white%20background%20soft%20lighting%20professional%20product%20photography%20high%20quality%20sharp%20details%20modern%20home%20furniture%20aesthetic&width=400&height=400&seq=listing12&orientation=squarish',
    ...
    setTimeout(() => {
      ...
      if (urlCategory && urlCategory !== 'All Categories') {
        ...
        if (keywords.length > 0) {
          filteredListings = filteredListings.filter(listing =>
            keywords.some(keyword => listing.title.toLowerCase().includes(keyword))
          );
        }
      }
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#1B1B1B' }}>
      ...
      <main className="max-w-[1440px] mx-auto px-6">
        {/* Page Title Block */}
        <div className="text-center" style={{ paddingTop: '60px', paddingBottom: '40px' }}>
        ...
        {/* Filter & Sort Bar */}
        <div className="rounded-xl p-4 mb-8" style={{ backgroundColor: '#262626' }}>
          <div className="flex items-center gap-4 flex-wrap">
                ...
                >
                  {sortOptions.map((option) => (
                    <button
                      ...
                      style={{
                        backgroundColor: option === selectedSort ? '#4A4A4A' : 'transparent',
                        color: '#F5F3F0'
                      }}
                    >
                      {option}
                ...
                >
                  {categories.map((category) => (
                    <button
                      ...
                      className="w-full px-4 py-3 text-left text-sm cursor-pointer transition-all hover:brightness-110"
                      style={{
                        backgroundColor: category === selectedCategory ? '#4A4A4A' : 'transparent',
                        color: '#F5F3F0'
                      }}
                    >
                      {category}
            ...
            >
              <i className={trustedOnly ? 'ri-checkbox-circle-fill' : 'ri-checkbox-blank-circle-line'} style={{ fontSize: '18px' }}></i>
          ...
          <div className="grid grid-cols-3 gap-6 mb-16">
            {[...Array(6)].map((_, index) => (
              ...
              >
                ...
                ></div>
                <div className="h-5 rounded mb-3 animate-pulse" style={{ backgroundColor: '#3A3A3A', width: '80%' }}></div>
                <div className="h-6 rounded mb-3 animate-pulse" style={{ backgroundColor: '#3A3A3A', width: '40%' }}></div>
                <div className="h-4 rounded mb-2 animate-pulse" style={{ backgroundColor: '#3A3A3A', width: '60%' }}></div>
                <div className="h-4 rounded animate-pulse" style={{ backgroundColor: '#3A3A3A', width: '50%' }}></div>
              </div>
            ))}
          </div>
        ) : listings.length > 0 ? (
            ...
            <div className="grid grid-cols-3 gap-6 mb-12">
              {listings.map((listing) => (
                ...
                >
                  ...
                  />
                  <h3 className="text-base font-semibold mb-2 line-clamp-2" style={{ color: '#F5F3F0' }}>
                    {listing.title}
                  </h3>
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    <i className="ri-checkbox-circle-fill" style={{ color: getTrustColor(listing.trustLevel), fontSize: '16px' }}></i>
                    <span className="text-sm font-medium" style={{ color: getTrustColor(listing.trustLevel) }}>
                      {listing.trustLevel}
                    </span>
        ...
        {/* Safety Note */}
        <div className="rounded-xl p-5 mb-16 text-center" style={{ backgroundColor: '#262626' }}>
          <p className="text-xs" style={{ color: '#B3ADA7' }}>
            All payments are secured through blockchain-based escrow. No off-platform messaging required.
          </p>
        </div>
      </main>
