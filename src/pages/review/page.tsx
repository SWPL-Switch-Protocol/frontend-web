      ...
      >
        ...
        <main className="flex-1 flex items-center justify-center px-6 py-20">
          <div className="text-center">
            ...
            >
              <i
                className="ri-check-line text-4xl"
                style={{ color: "#4CAF50" }}
              ></i>
            </div>
            <h2
          ...
          >
            ...
            <div className="pt-4" style={{ borderTop: "1px solid #2B2B2B" }}>
              <p className="text-xs" style={{ color: "#8F8A84" }}>
                Your review will be recorded as part of your on-chain
                reputation.
              </p>
            </div>
          </div>
              ...
              {[1, 2, 3, 4, 5].map((star) => (
                ...
                >
                  <i
                    ...
                    style={{
                      color:
                        star <= (hoverRating || rating) ? "#FF8C42" : "#5A5A5A",
                      fontSize: "32px",
                    }}
                  ></i>
                </button>
          ...
          >
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0">
                {showSuspicious ? (
                  <i
                    className="ri-alert-line text-xl"
                    style={{ color: "#FFA500" }}
                  ></i>
                ) : (
                  <i
              ...
              style={{
                ...
                color:
                  rating === 0 || reviewText.trim().length === 0
                    ...
                    : "#FFFFFF",
                opacity:
                  rating === 0 || reviewText.trim().length === 0 ? 0.6 : 1,
                height: "54px",
              }}
            >
              Submit review
