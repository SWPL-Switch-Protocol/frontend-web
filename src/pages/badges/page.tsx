...
const BadgesPage = () => {
  ...
  const tabs = ['Trading', 'Community', 'DAO participation', 'Location', 'Special'];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12" style={{ paddingTop: '60px' }}>
            ...
            <p className="text-lg" style={{ color: '#B3ADA7' }}>
              Badges are non-transferable SBTs permanently linked to your wallet.
            </p>
          </div>
          ...
          >
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                >
                  <i className="ri-wallet-line text-xl" style={{ color: '#FFFFFF' }}></i>
                </div>
                <div>
                  <p className="font-mono text-sm mb-1" style={{ color: '#B3ADA7' }}>
                    0xA3...91c5
                  </p>
              ...
              <div className="text-center md:text-right">
                <p className="text-3xl font-bold mb-1" style={{ color: '#FF8C42' }}>
                  13
                </p>
                <p className="text-sm" style={{ color: '#B3ADA7' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {badgesData[activeTab as keyof typeof badgesData].map((badge, index) => (
              <BadgeCard
                key={index}
                icon={badge.icon}
                name={badge.name}
          ...
          >
            <div className="flex items-start gap-4">
              ...
              >
                <i className="ri-lock-line text-xl" style={{ color: '#8F8A84' }}></i>
              </div>
              <div>
                ...
                <p className="text-sm" style={{ color: '#B3ADA7' }}>
                  Locked badges show what you can unlock next through trusted activity.
                </p>
              </div>
            </div>
          </div>
