  ...
  const proposals = [
    {
      ...
      description: 'Host a recurring Saturday meetup in Domino Park for verified neighbors — focused on sharing local updates, helping newcomers, and strengthening community trust.',
    ...
    },
    {
      ...
      description: 'A monthly bonsai workshop hosted at a local garden space. Members can bring plants, share tips, and earn recognition badges for contributions.',
  ...
  if (!hasAccess) {
    return (
      <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#1B1B1B' }}>
        ...
        <main className="flex-1 flex items-center justify-center px-6 py-20">
          <div className="text-center max-w-md rounded-2xl p-8" style={{ backgroundColor: '#1F1F1F' }}>
            <div className="text-6xl mb-6">🔒</div>
            <h2 className="text-3xl font-bold mb-4" style={{ color: '#F5F3F0' }}>
            ...
            <ul className="text-left mb-8 space-y-2">
              <li className="flex items-center gap-2" style={{ color: '#D8D2CD' }}>
                <i className="ri-checkbox-circle-line" style={{ color: '#FF8C42' }}></i>
                Verified reputation
              </li>
              <li className="flex items-center gap-2" style={{ color: '#D8D2CD' }}>
                <i className="ri-checkbox-circle-line" style={{ color: '#FF8C42' }}></i>
        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="text-center mb-8" style={{ paddingTop: '40px' }}>
            ...
            <p className="text-lg" style={{ color: '#B3ADA7' }}>
              Community proposals require verification and voting from trusted residents.
            </p>
          </div>

          <div className="mb-8" style={{ borderBottom: '1px solid #2B2B2B' }}></div>
          ...
          >
            <h2 className="text-3xl font-bold mb-6" style={{ color: '#F5F3F0' }}>
              {proposal.title}
            </h2>

            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-2">
                <span className="text-sm" style={{ color: '#B3ADA7' }}>Created by:</span>
                <span className="text-sm font-semibold" style={{ color: '#F5F3F0' }}>{proposal.creator}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-sm" style={{ color: '#B3ADA7' }}>Created:</span>
                <span className="text-sm font-semibold" style={{ color: '#F5F3F0' }}>{proposal.createdDate}</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="mb-6">
              <h3 className="text-lg font-semibold mb-3" style={{ color: '#F5F3F0' }}>
                Proposal description
              </h3>
              <p className="text-base leading-relaxed mb-4" style={{ color: '#D8D2CD' }}>
                {proposal.description}
              </p>
              <div className="flex items-center gap-2">
                <span className="text-sm" style={{ color: '#B3ADA7' }}>Category:</span>
                <span className="text-sm font-medium" style={{ color: '#FF8C42' }}>
                  {proposal.category}
                </span>
              </div>
            </div>
            ...
            {/* Proposal Metrics */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-6" style={{ borderTop: '1px solid #2B2B2B' }}>
              <div>
                <p className="text-xs mb-1" style={{ color: '#8F8A84' }}>Current support:</p>
                <p className="text-xl font-bold" style={{ color: '#FF8C42' }}>{proposal.currentSupport}% Yes</p>
              </div>
              <div>
                <p className="text-xs mb-1" style={{ color: '#8F8A84' }}>Total voters:</p>
                <p className="text-xl font-bold" style={{ color: '#F5F3F0' }}>{proposal.totalVoters} residents</p>
              </div>
              <div>
                <p className="text-xs mb-1" style={{ color: '#8F8A84' }}>Required threshold:</p>
                <p className="text-xl font-bold" style={{ color: '#F5F3F0' }}> &gt; {proposal.requiredThreshold}% Yes</p>
              </div>
              <div>
                <p className="text-xs mb-1" style={{ color: '#8F8A84' }}>Proposal stage:</p>
                <p className="text-xl font-bold" style={{ color: '#F5F3F0' }}>{proposal.stage}</p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div className="space-y-3 mb-6">
                <label
                  ...
                  style={{
                    backgroundColor: selectedVote === 'yes' ? '#1F1F1F' : 'transparent',
                ...
                <label
                  className="flex items-center gap-3 p-4 rounded-xl cursor-pointer transition-all hover:brightness-110"
                  style={{
                    backgroundColor: selectedVote === 'no' ? '#1F1F1F' : 'transparent',
                ...
                <label
                  className="flex items-center gap-3 p-4 rounded-xl cursor-pointer transition-all hover:brightness-110"
                  style={{
                    backgroundColor: selectedVote === 'abstain' ? '#1F1F1F' : 'transparent',
                    border: `1px solid ${selectedVote === 'abstain' ? '#FF8C42' : '#3A3A3A'}`,
                  }}
                >
                  <input
                    type="radio"
