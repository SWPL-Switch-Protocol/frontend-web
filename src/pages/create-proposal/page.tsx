...
const CreateProposalPage = () => {
  ...
  const isFormValid = formData.title.length >= 10 && formData.category && formData.description.length >= 50;
  ...
  if (isSubmitted) {
    return (
      <div className="min-h-screen" style={{ backgroundColor: '#1B1B1B' }}>
        ...
        <main className="flex-1 flex items-center justify-center px-6 py-20">
          <div className="text-center max-w-md rounded-2xl p-10" style={{ backgroundColor: '#1F1F1F' }}>
            <div className="text-6xl mb-6">✅</div>
            <h2 className="text-3xl font-bold mb-4" style={{ color: '#F5F3F0' }}>
              Proposal submitted
            </h2>
      ...
      <main className="max-w-[1440px] mx-auto px-6">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="text-center mb-8" style={{ paddingTop: '48px' }}>
            ...
            <p className="text-lg" style={{ color: '#B3ADA7' }}>
              Submit ideas for your neighborhood. Proposals require approval from trusted residents.
            </p>
          </div>
          ...
          {/* Guidance Section */}
          <div className="mb-8 rounded-2xl p-6" style={{ backgroundColor: '#1F1F1F' }}>
            ...
            <ul className="space-y-2 mb-4">
              <li className="flex items-center gap-2 text-sm" style={{ color: '#D8D2CD' }}>
                <span>🌿</span>
          ...
          <form onSubmit={handleSubmit}>
            <div className="rounded-2xl p-8 space-y-6" style={{ backgroundColor: '#1F1F1F' }}>
              {/* Title Field */}
              <div>
                <label className="block text-sm font-semibold mb-2" style={{ color: '#F5F3F0' }}>
              ...
              <div className="pt-4" style={{ borderTop: '1px solid #2B2B2B' }}>
                <h3 className="text-base font-semibold mb-4" style={{ color: '#F5F3F0' }}>
                  Optional details
                </h3>

                {/* Location */}
                <div className="mb-4">
                  <label className="block text-sm font-medium mb-2" style={{ color: '#D8D2CD' }}>
                    Location
                  </label>
                  <input
                    type="text"
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange('treasuryAmount', e.target.value)}
                    className="w-full px-4 py-3 rounded-lg text-sm outline-none"
                    style={{ backgroundColor: '#262626', color: '#F5F3F0' }}
                  />
                  <p className="text-xs mt-1" style={{ color: '#8F8A84' }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange('supportingLink', e.target.value)}
                    className="w-full px-4 py-3 rounded-lg text-sm outline-none"
                    style={{ backgroundColor: '#262626', color: '#F5F3F0' }}
                  />
                </div>
              ...
              <div className="pt-6" style={{ borderTop: '1px solid #2B2B2B' }}>
                <h3 className="text-base font-semibold mb-3" style={{ color: '#F5F3F0' }}>
                  Requirements check
                </h3>
                <div className="space-y-2 mb-3">
                  {requirements.map((req, index) => (
                    <div key={index} className="flex items-center gap-2">
                      <i 
                        className={req.met ? 'ri-checkbox-circle-fill' : 'ri-close-circle-line'} 
                        style={{ color: req.met ? '#6E8B5E' : '#8F8A84' }}
                      ></i>
                      <span className="text-sm" style={{ color: req.met ? '#D8D2CD' : '#8F8A84' }}>
                        {req.label}
                      </span>
                    </div>
                  ))}
              ...
              <div className="pt-4">
                ...
                {!isFormValid && (
                  <p className="text-xs mt-2 text-center" style={{ color: '#8F8A84' }}>
