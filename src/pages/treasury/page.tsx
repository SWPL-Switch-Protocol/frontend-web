      ...
      <main className="flex-1 px-6 py-16">
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="text-center mb-12" style={{ paddingTop: '50px' }}>
            ...
            <p className="text-lg max-w-[700px] mx-auto" style={{ color: '#B3ADA7' }}>
              Funds are governed by reputation-based voting and cannot be withdrawn without proposal approval.
            </p>
          </div>

          {/* Treasury Balance Card */}
          <div className="rounded-2xl p-10 mb-12" style={{ backgroundColor: '#1F1F1F' }}>
            <div className="text-center mb-8">
              <p className="text-sm mb-2" style={{ color: '#B3ADA7' }}>Current balance</p>
              <h2 className="text-6xl font-bold mb-6" style={{ color: '#FF8C42' }}>
                $2,450
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div className="text-center">
                ...
                <p className="text-xl font-semibold" style={{ color: '#F5F3F0' }}>3 days ago</p>
              </div>
              <div className="text-center">
                <p className="text-sm mb-1" style={{ color: '#B3ADA7' }}>Total contributors:</p>
                <p className="text-xl font-semibold" style={{ color: '#F5F3F0' }}>32</p>
              </div>
              <div className="text-center">
                <p className="text-sm mb-1" style={{ color: '#B3ADA7' }}>Current proposals affecting funds:</p>
                <p className="text-xl font-semibold" style={{ color: '#F5F3F0' }}>1 active</p>
              </div>
            </div>
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-4 flex-1">
                      ...
                      >
                        <i className={transaction.icon} style={{ color: transaction.iconColor, fontSize: '24px' }}></i>
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          <h4 className="text-lg font-semibold" style={{ color: '#F5F3F0' }}>
                            {transaction.title}
                          </h4>
                          {transaction.status && (
                            <span
                              ...
                              style={{
                                backgroundColor: transaction.status === 'Passed' ? '#E8F0E6' : '#FFF4E6',
                                color: transaction.status === 'Passed' ? '#6E8B5E' : '#D97706',
                              }}
                            >
                              {transaction.status}
                            </span>
                    ...
                    <div className="text-right flex-shrink-0">
                      <p
                        ...
                        style={{ color: transaction.type === 'income' ? '#4CAF50' : '#F5F3F0' }}
                      >
                        {transaction.amount}
                      </p>
                    </div>
          ...
          <div className="mb-12">
            ...
            <div className="rounded-2xl p-8" style={{ backgroundColor: '#1F1F1F' }}>
              {/* Horizontal Bar */}
              <div className="mb-8">
                <div className="flex h-12 rounded-full overflow-hidden" style={{ backgroundColor: '#262626' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {allocationData.map((item, index) => (
                  <div key={index} className="flex items-center gap-3">
                    ...
                    ></div>
                    <div className="flex-1">
                      <p className="text-sm font-medium" style={{ color: '#F5F3F0' }}>
                        {item.category}
                      </p>
          ...
          >
            <div className="text-center mb-6">
              ...
              <p className="text-base max-w-[600px] mx-auto" style={{ color: '#B3ADA7' }}>
                Only verified residents with on-chain reputation can submit treasury proposals.
              </p>
            </div>
